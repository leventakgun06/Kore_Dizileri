...
class _SeriesListState extends State<SeriesList> {
  ...
  Widget getBodyUI() {
    return Column(
      ...
      children: [
        Expanded(
          child: Consumer(
            builder: (context, SerieProvider koreaProvider, child) {
  ...
  ListTile _listTile(SerieProvider koreaProvider, int index) {
    return ListTile(
      dense: true,
      ...
      onTap: () {
        context.navigateToPage(
          MyGlobalDetail(
            korea: koreaProvider.searchedKorea.data[index],
          ),
        );
      },
    );
  ...
  void _sort(SerieProvider koreaProvider) {

...
class _MoviesListState extends State<MoviesList> {
  ...
  Widget build(BuildContext context) {
    final series = Provider.of<MovieProvider>(context);
      ...
      children: [
        Column(
          children: [
            ...
            Text(textMoviesi, style: fontSFProBold50),
          ],
        ),
  ...
  Widget getBodyUI() {
    return Column(
      ...
      children: [
        Expanded(
          child: Consumer(
            builder: (context, MovieProvider koreaProvider, child) {
  ...
  ListTile _listTile(MovieProvider koreaProvider, int index) {
    return ListTile(
      dense: true,
  ...
  void _sort(MovieProvider koreaProvider) {
